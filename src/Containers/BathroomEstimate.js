...
import BathroomEstimateBanner from "../Common/BannerParts/BathroomEstimateBanner";
...
class BathroomEstimate extends Component {
  constructor(props) {
    super(props);
...
export default BathroomEstimate;
