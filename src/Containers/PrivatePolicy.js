...
class PrivatePolicy extends Component {
  ...
  render() {
    return (
      <>
        <Helmet>
          <title>AGM Basements | Basement Renovations | Private Policy</title>
        </Helmet>
        <GeneralBanner title="Private Policy" />
        <div className="container mt-5">
          <p>Last updated: (8/6/2019)</p>
          <p>AGM Basements (“us”, “we”, or “our”) operates https://www.agmrenovations.com (the “Site”). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
          ...
          <p>This Privacy Policy is effective as of (8/6/2019) and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
