        ...
        <div id="thank-you-page">
          <div className="container">
            <div className="thank-you">
                <h5>Your form has been sent successfully, We will contact you soon.</h5>

                <div className="finance-it-banner">
                  <h4>Save your <span>money</span></h4>
          ...
          <div style={{display: 'inline'}}>
            <img height="1" width="1" style={{borderStyle: 'none'}} alt="" src="//www.googleadservices.com/pagead/conversion/952060088/?label=LofTCPj79msQuJH9xQM&amp;guid=ON&amp;script=0"/>
          </div>
        </div>      
      </>
    );
