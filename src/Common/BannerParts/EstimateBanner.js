...
class EstimateHeader extends Component {
  ...
  render() {
    return (
      <section id="home-banner" className="estimate-header-contain" style={{ backgroundImage: `url(${isWebpSupported() ? HomeBannerImageWebP : HomeBannerImage})` }}>
        <div className="banner-cover">
          <div className="banner-content estimate d-flex align-items-center" style={{ width: '90%' }}>
            <div className="left" style={{ paddingLeft: '1.5rem' }}>
              <h1 style={{ marginLeft: '0' }}>The Best in Basement Renovations</h1>
              <div className="text-desktop">
                <p>Our team of accredited Interior Designers and Licensed Building Professionals are ready to make your vision a reality. We would be honoured to have you choose AGM Basements for your basement renovation project. All estimates are free of charge.</p>
              </div>
              <h3 className="text-white">Contact Us Now For A Free Estimate.</h3>
            </div>
                  ...
                  <form onSubmit={this.handleSubmit} id="estimateform">
                    <div className="estimate-inputs">
                      <div className="input-holder full-name">
                        ...
                        <input type="text" required className="full_name" name="fullName" placeholder="Full Name" onChange={this.updateEstimateFormData} />
                      ...
                      <div className="input-holder phone-number">
                        ...
                        <input type="tel" required className="phone_number" name="phoneNumber" placeholder="Mobile Phone Number" onChange={this.updateEstimateFormData} />
                        <div className="error-message"></div>
                      </div>
                      ...
                      <div className="input-holder city">
                        ...
                        <input type="text" required className="city" name="city" placeholder="City" onChange={this.updateEstimateFormData} />
                        <div className="error-message"></div>
                      </div>
                      ...
                      <div className="input-holder email">
                        ...
                        <input type="email" required className="email" name="email" placeholder="E-mail Address" onChange={this.updateEstimateFormData} />
                        <div className="error-message"></div>
                      </div>
                      ...
                      <div className="input-holder size-of-house">
                        ...
                        <input type="number" required className="sqFt" name="sqFt" placeholder="Size of House (sq/ft)" onChange={this.updateEstimateFormData} />
                        <div className="error-message"></div>
                      </div>
                    </div>

                    <div className="submit-btn">
                      <button className="estimate-form-submit" type="submit">Schedule Now</button>
                    </div>
                  </form>
                </div>
              </div>
